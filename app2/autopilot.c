...
void Flight_Task(void){
	...
	for(;;){
		...
		if (((quadrotor.joystick.buttons & BTN_LEFT1) != 0) && ((quadrotor.joystick.buttons & BTN_RIGHT1) == 0)){
			quadrotor.sv.setpoint[YAW] = -45.0;
		}else if (((quadrotor.joystick.buttons & BTN_LEFT1) == 0) && ((quadrotor.joystick.buttons & BTN_RIGHT1) != 0)){
			quadrotor.sv.setpoint[YAW] = 45.0;
		}
